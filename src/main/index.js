import { app, shell, BrowserWindow, ipcMain, ipcRenderer, contextBridge } from "electron";
...
function createWindow() {
  ...
  const mainWindow = new BrowserWindow({
    ...
    fullscreenable: false, // This will prevent fullscreen
    icon,
    webPreferences: {
  ...
  ipcMain.on("maximize-or-restore-window", () => {
